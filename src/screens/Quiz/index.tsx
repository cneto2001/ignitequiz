...
import Animated, { useAnimatedStyle, useSharedValue, withSequence, withTiming, interpolate, useAnimatedScrollHandler, Extrapolate, runOnJS } from 'react-native-reanimated';
